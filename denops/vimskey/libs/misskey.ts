...
export const sendNoteReq = async (denops: Denops, params: {visibility?: Visibility, body: string}) => {
  const origin = await getVimValue(denops, { type: "g", name: "instance#origin"  })
